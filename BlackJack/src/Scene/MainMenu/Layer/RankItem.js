var RankItemLayer = cc.Layer.extend({
    ...
    loadItem: function (num, headImg, name, golds) {
        ...
        var bottomLine = new cc.Scale9Sprite('res/fengexian.png', cc.rect(0, 0, 20, 2), cc.rect(5, 0, 15, 2));
        ...
        var playerBorder = new cc.Sprite('#Stroke_photo.png');
        layout.addChild(playerBorder);
        playerBorder.setPosition(180, layout.getContentSize().height / 2);

        var playerPhoto = new cc.Sprite('#' + headImg + '.png');
        ...
        var nameText = new ccui.Text(name, "AmericanTypewriter", 26);
        layout.addChild(nameText);
        nameText.setAnchorPoint(0, 1);
        nameText.setPosition(260, 90);

        var goldNum = new ccui.Text(golds, "AmericanTypewriter", 30);
